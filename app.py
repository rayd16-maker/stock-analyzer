...
def load_stocks_data():
    ...
    default_stocks = {
         # ==================== الطاقة (نقبة) ====================
    '2030': {'name': 'المصافي', 'sector': 'الطاقة', 'opinion': 'نقبة'},
    '2381': {'name': 'الحفر العربية', 'sector': 'الطاقة', 'opinion': 'نقبة'},
    '4030': {'name': 'البحري', 'sector': 'الطاقة', 'opinion': 'نقبة'},
    '4200': {'name': 'الدريس', 'sector': 'الطاقة', 'opinion': 'نقبة'},
    '2380': {'name': 'بترو رابع', 'sector': 'الطاقة', 'opinion': 'مختلطة'},
    
    # ==================== المواد الأساسية (نقبة) ====================
    '1210': {'name': 'في سي اي', 'sector': 'المواد الأساسية', 'opinion': 'نقبة'},
    '1301': {'name': 'أسلاك', 'sector': 'المواد الأساسية', 'opinion': 'نقبة'},
    '1321': {'name': 'أنابيب الشرق', 'sector': 'المواد الأساسية', 'opinion': 'نقبة'},
    '1322': {'name': 'أماك', 'sector': 'المواد الأساسية', 'opinion': 'نقبة'},
    '2001': {'name': 'كيمانول', 'sector': 'المواد الأساسية', 'opinion': 'نقبة'},
    '2020': {'name': 'سابك للمغذيات الزراعية', 'sector': 'المواد الأساسية', 'opinion': 'نقبة'},
    '2090': {'name': 'جبسكو', 'sector': 'المواد الأساسية', 'opinion': 'نقبة'},
    '2150': {'name': 'زجاج', 'sector': 'المواد الأساسية', 'opinion': 'نقبة'},
    '2170': {'name': 'اللجين', 'sector': 'المواد الأساسية', 'opinion': 'نقبة'},
    '2180': {'name': 'فيبكو', 'sector': 'المواد الأساسية', 'opinion': 'نقبة'},
    '2200': {'name': 'أنابيب', 'sector': 'المواد الأساسية', 'opinion': 'نقبة'},
    '2210': {'name': 'نماة للكيماويات', 'sector': 'المواد الأساسية', 'opinion': 'نقبة'},
    '2220': {'name': 'معدنية', 'sector': 'المواد الأساسية', 'opinion': 'نقبة'},
    '2223': {'name': 'لوبريف', 'sector': 'المواد الأساسية', 'opinion': 'نقبة'},
    '2240': {'name': 'الزامل للصناعة', 'sector': 'المواد الأساسية', 'opinion': 'نقبة'},
    '2250': {'name': 'المجموعة السعودية', 'sector': 'المواد الأساسية', 'opinion': 'نقبة'},
    '2290': {'name': 'ينساب', 'sector': 'المواد الأساسية', 'opinion': 'نقبة'},
    '2310': {'name': 'سيكيم العالمية', 'sector': 'المواد الأساسية', 'opinion': 'نقبة'},
    '2330': {'name': 'المتقدمة', 'sector': 'المواد الأساسية', 'opinion': 'نقبة'},
    '2350': {'name': 'كيان السعودية', 'sector': 'المواد الأساسية', 'opinion': 'نقبة'},
    '2360': {'name': 'الخبارية', 'sector': 'المواد الأساسية', 'opinion': 'نقبة'},
    '3002': {'name': 'أسمنت نجران', 'sector': 'المواد الأساسية', 'opinion': 'نقبة'},
    '3003': {'name': 'أسمنت المدينة', 'sector': 'المواد الأساسية', 'opinion': 'نقبة'},
    '3004': {'name': 'أسمنت الشمالية', 'sector': 'المواد الأساسية', 'opinion': 'نقبة'},
    '3005': {'name': 'أسمنت أم القرى', 'sector': 'المواد الأساسية', 'opinion': 'نقبة'},
    '3007': {'name': 'الواحة', 'sector': 'المواد الأساسية', 'opinion': 'نقبة'},
    '3010': {'name': 'أسمنت العربية', 'sector': 'المواد الأساسية', 'opinion': 'نقبة'},
    '3020': {'name': 'أسمنت اليمامة', 'sector': 'المواد الأساسية', 'opinion': 'نقبة'},
    '3030': {'name': 'أسمنت السعودية', 'sector': 'المواد الأساسية', 'opinion': 'نقبة'},
    '3040': {'name': 'أسمنت القصيم', 'sector': 'المواد الأساسية', 'opinion': 'نقبة'},
    '3080': {'name': 'أسمنت الشرقية', 'sector': 'المواد الأساسية', 'opinion': 'نقبة'},
    '3090': {'name': 'أسمنت تبوك', 'sector': 'المواد الأساسية', 'opinion': 'نقبة'},
    
    # ==================== المواد الأساسية (مختلطة) ====================
    '1202': {'name': 'ميكو', 'sector': 'المواد الأساسية', 'opinion': 'مختلطة'},
    '1211': {'name': 'معادن', 'sector': 'المواد الأساسية', 'opinion': 'مختلطة'},
    '1320': {'name': 'أنابيب السعودية', 'sector': 'المواد الأساسية', 'opinion': 'مختلطة'},
    '1323': {'name': 'يو سي آي سي', 'sector': 'المواد الأساسية', 'opinion': 'مختلطة'},
    '2010': {'name': 'سابك', 'sector': 'المواد الأساسية', 'opinion': 'مختلطة'},
    '2060': {'name': 'التصنيع', 'sector': 'المواد الأساسية', 'opinion': 'مختلطة'},
    '2300': {'name': 'صناعة الورق', 'sector': 'المواد الأساسية', 'opinion': 'مختلطة'},
    '3008': {'name': 'الكثير', 'sector': 'المواد الأساسية', 'opinion': 'مختلطة'},
    '3050': {'name': 'أسمنت الجنوب', 'sector': 'المواد الأساسية', 'opinion': 'مختلطة'},
    '3060': {'name': 'أسمنت ينبع', 'sector': 'المواد الأساسية', 'opinion': 'مختلطة'},
    '3091': {'name': 'أسمنت الجوف', 'sector': 'المواد الأساسية', 'opinion': 'مختلطة'},
    '3092': {'name': 'أسمنت الرياض', 'sector': 'المواد الأساسية', 'opinion': 'مختلطة'},
    
    # ==================== المواد الأساسية (غير متوافقة) ====================
    '1201': {'name': 'تكوين', 'sector': 'المواد الأساسية', 'opinion': 'غير متوافقة'},
    '1304': {'name': 'البيامنة للحديد', 'sector': 'المواد الأساسية', 'opinion': 'غير متوافقة'},
    
    # ==================== السلع الرأس مالية ====================
    '1212': {'name': 'السابع الرأس مالية', 'sector': 'السلع الرأس مالية', 'opinion': 'نقبة'},
    '1214': {'name': 'شاكر', 'sector': 'السلع الرأس مالية', 'opinion': 'نقبة'},
    '1302': {'name': 'بوان', 'sector': 'السلع الرأس مالية', 'opinion': 'نقبة'},
    '1303': {'name': 'الصناعات الكهربائية', 'sector': 'السلع الرأس مالية', 'opinion': 'نقبة'},
    '2040': {'name': 'الخزف السعودي', 'sector': 'السلع الرأس مالية', 'opinion': 'نقبة'},
    '2110': {'name': 'الكابلات السعودية', 'sector': 'السلع الرأس مالية', 'opinion': 'نقبة'},
    '2160': {'name': 'أمياتنتين', 'sector': 'السلع الرأس مالية', 'opinion': 'نقبة'},
    '2320': {'name': 'الباطين', 'sector': 'السلع الرأس مالية', 'opinion': 'نقبة'},
    '2370': {'name': 'مسكن', 'sector': 'السلع الرأس مالية', 'opinion': 'نقبة'},
    '4110': {'name': 'باتك', 'sector': 'السلع الرأس مالية', 'opinion': 'نقبة'},
    '4140': {'name': 'صادرات', 'sector': 'السلع الرأس مالية', 'opinion': 'نقبة'},
    '4142': {'name': 'كابلات الرياض', 'sector': 'السلع الرأس مالية', 'opinion': 'نقبة'},
    '4143': {'name': 'تالكو', 'sector': 'السلع الرأس مالية', 'opinion': 'نقبة'},
    '4144': {'name': 'رؤوم', 'sector': 'السلع الرأس مالية', 'opinion': 'نقبة'},
    '4145': {'name': 'العيبكان للزجاج', 'sector': 'السلع الرأس مالية', 'opinion': 'نقبة'},
    '4141': {'name': 'العمران', 'sector': 'السلع الرأس مالية', 'opinion': 'مختلطة'},
    
    # ==================== الخدمات التجارية والمهنية ====================
    '1831': {'name': 'مهارة', 'sector': 'الخدمات التجارية والمهنية', 'opinion': 'نقبة'},
    '1832': {'name': 'صدر', 'sector': 'الخدمات التجارية والمهنية', 'opinion': 'نقبة'},
    '1833': {'name': 'الموارد', 'sector': 'الخدمات التجارية والمهنية', 'opinion': 'نقبة'},
    '1834': {'name': 'سماسكو', 'sector': 'الخدمات التجارية والمهنية', 'opinion': 'نقبة'},
    '1835': {'name': 'تمكين', 'sector': 'الخدمات التجارية والمهنية', 'opinion': 'نقبة'},
    '4270': {'name': 'طباعة وتغليف', 'sector': 'الخدمات التجارية والمهنية', 'opinion': 'غير متوافقة'},
    '6004': {'name': 'كاترون', 'sector': 'الخدمات التجارية والمهنية', 'opinion': 'مختلطة'},
    
    # ==================== النقل ====================
    '4031': {'name': 'الخدمات الأرضية', 'sector': 'النقل', 'opinion': 'نقبة'},
    '4040': {'name': 'سابتكو', 'sector': 'النقل', 'opinion': 'نقبة'},
    '4260': {'name': 'بدجت السعودية', 'sector': 'النقل', 'opinion': 'نقبة'},
    '4261': {'name': 'ذيبة', 'sector': 'النقل', 'opinion': 'نقبة'},
    '4262': {'name': 'لومي', 'sector': 'النقل', 'opinion': 'نقبة'},
    '4264': {'name': 'ناس', 'sector': 'النقل', 'opinion': 'نقبة'},
    '2190': {'name': 'سياسكو القابضة', 'sector': 'النقل', 'opinion': 'مختلطة'},
    '4263': {'name': 'سال', 'sector': 'النقل', 'opinion': 'مختلطة'},
    
    # ==================== السلع طويلة الأجل ====================
    '2130': {'name': 'صدق', 'sector': 'السلع طويلة الأجل', 'opinion': 'نقبة'},
    '2340': {'name': 'ارتيكس', 'sector': 'السلع طويلة الأجل', 'opinion': 'نقبة'},
    '4011': {'name': 'لازوردي', 'sector': 'السلع طويلة الأجل', 'opinion': 'نقبة'},
    '4012': {'name': 'الأصيل', 'sector': 'السلع طويلة الأجل', 'opinion': 'نقبة'},
    '4180': {'name': 'مجموعة فتيحي', 'sector': 'السلع طويلة الأجل', 'opinion': 'نقبة'},
    '1213': {'name': 'نسيج', 'sector': 'السلع طويلة الأجل', 'opinion': 'غير متوافقة'},
    
    # ==================== الخدمات الإستهلاكية ====================
    '1810': {'name': 'سيرا', 'sector': 'الخدمات الإستهلاكية', 'opinion': 'نقبة'},
    '1820': {'name': 'بان', 'sector': 'الخدمات الإستهلاكية', 'opinion': 'نقبة'},
    '1830': {'name': 'لجام للرياضة', 'sector': 'الخدمات الإستهلاكية', 'opinion': 'نقبة'},
    '4170': {'name': 'شمس', 'sector': 'الخدمات الإستهلاكية', 'opinion': 'نقبة'},
    '4290': {'name': 'الخليج للتدريب', 'sector': 'الخدمات الإستهلاكية', 'opinion': 'نقبة'},
    '4291': {'name': 'الوطنية للتعليم', 'sector': 'الخدمات الإستهلاكية', 'opinion': 'نقبة'},
    '4292': {'name': 'عطاء', 'sector': 'الخدمات الإستهلاكية', 'opinion': 'نقبة'},
    '6002': {'name': 'هرف للأغذية', 'sector': 'الخدمات الإستهلاكية', 'opinion': 'نقبة'},
    '6012': {'name': 'ريدان', 'sector': 'الخدمات الإستهلاكية', 'opinion': 'نقبة'},
    '6013': {'name': 'التطويرية الغذائية', 'sector': 'الخدمات الإستهلاكية', 'opinion': 'نقبة'},
    '6014': {'name': 'الأمار', 'sector': 'الخدمات الإستهلاكية', 'opinion': 'نقبة'},
    '6016': {'name': 'برغرايزر', 'sector': 'الخدمات الإستهلاكية', 'opinion': 'نقبة'},
    '6015': {'name': 'أمريكا', 'sector': 'الخدمات الإستهلاكية', 'opinion': 'مختلطة'},
    '6018': {'name': 'الأنذية للرياضة', 'sector': 'الخدمات الإستهلاكية', 'opinion': 'مختلطة'},
    '6017': {'name': 'جاهز', 'sector': 'الخدمات الإستهلاكية', 'opinion': 'غير متوافقة'},
    
    # ==================== الإعلام والترفيه ====================
    '4071': {'name': 'العربية', 'sector': 'الإعلام والترفيه', 'opinion': 'نقبة'},
    '4070': {'name': 'تهامة', 'sector': 'الإعلام والترفيه', 'opinion': 'مختلطة'},
    '4072': {'name': 'مجموعة إم بي سي', 'sector': 'الإعلام والترفيه', 'opinion': 'غير متوافقة النشاط'},
    '4210': {'name': 'الأبحاث والإعلام', 'sector': 'الإعلام والترفيه', 'opinion': 'غير متوافقة النشاط'},
    
    # ==================== تجزئة السلع الكمالية ====================
    '4008': {'name': 'ساكو', 'sector': 'تجزئة السلع الكمالية', 'opinion': 'نقبة'},
    '4050': {'name': 'ساسكو', 'sector': 'تجزئة السلع الكمالية', 'opinion': 'نقبة'},
    '4003': {'name': 'اكستر', 'sector': 'تجزئة السلع الكمالية', 'opinion': 'مختلطة'},
    '4240': {'name': 'سينوي رينيل', 'sector': 'تجزئة السلع الكمالية', 'opinion': 'مختلطة'},
    
    # ==================== تجزئة وتوزيع السلع الاستهلاكية ====================
    '4006': {'name': 'أسواق المزرعة', 'sector': 'تجزئة وتوزيع السلع الاستهلاكية', 'opinion': 'مختلطة'},
    
    # ==================== إنتاج الأغذية ====================
    '2050': {'name': 'مجموعة صافولا', 'sector': 'إنتاج الأغذية', 'opinion': 'مختلطة'},
    '2283': {'name': 'المطاحن الأولى', 'sector': 'إنتاج الأغذية', 'opinion': 'مختلطة'},
    '2284': {'name': 'المطاحن الحديثة', 'sector': 'إنتاج الأغذية', 'opinion': 'مختلطة'},
    '6050': {'name': 'الأسماك', 'sector': 'إنتاج الأغذية', 'opinion': 'غير متوافقة'},
    '6060': {'name': 'الشرقية للتنمية', 'sector': 'إنتاج الأغذية', 'opinion': 'غير متوافقة'},
    
    # ==================== الرعاية الصحية ====================
    '2140': {'name': 'أيان', 'sector': 'الرعاية الصحية', 'opinion': 'مختلطة'},
    '4002': {'name': 'المواساة', 'sector': 'الرعاية الصحية', 'opinion': 'مختلطة'},
    '4005': {'name': 'رعاية', 'sector': 'الرعاية الصحية', 'opinion': 'مختلطة'},
    '4007': {'name': 'الحمادي', 'sector': 'الرعاية الصحية', 'opinion': 'مختلطة'},
    '4009': {'name': 'السعودي الألماني الصحية', 'sector': 'الرعاية الصحية', 'opinion': 'مختلطة'},
    '4017': {'name': 'فقه الطبية', 'sector': 'الرعاية الصحية', 'opinion': 'مختلطة'},
    '4018': {'name': 'الموسى', 'sector': 'الرعاية الصحية', 'opinion': 'غير متوافقة'},
    
    # ==================== الخدمات المالية ====================
    '4084': {'name': 'دراية', 'sector': 'الخدمات المالية', 'opinion': 'غير متوافقة'},
    '4280': {'name': 'المملكة', 'sector': 'الخدمات المالية', 'opinion': 'غير متوافقة النشاط'},
    
    # ==================== المرافق العامة ====================
    '2082': {'name': 'أكوا باور', 'sector': 'المرافق العامة', 'opinion': 'غير متوافقة'},
    
    # ==================== الصناديق العقارية المتداولة ====================
    '4334': {'name': 'المغذر ريت', 'sector': 'الصناديق العقارية المتداولة', 'opinion': 'غير متوافقة'},
    
    # ==================== إدارة وتطوير العقارات ====================
    '4220': {'name': 'إعمار', 'sector': 'إدارة وتطوير العقارات', 'opinion': 'غير متوافقة'},
    
    # ==================== أسهم إضافية من القائمة ====================
    '2222': {'name': 'أرامكو السعودية', 'sector': 'الطاقة', 'opinion': 'مختلطة'},
    '1120': {'name': 'البنك الأهلي السعودي', 'sector': 'البنوك', 'opinion': 'مختلطة'},
    '1090': {'name': 'مصرف الراجحي', 'sector': 'البنوك', 'opinion': 'مختلطة'},
    '1180': {'name': 'بنك الجزيرة', 'sector': 'البنوك', 'opinion': 'مختلطة'},
    '1150': {'name': 'البنك السعودي للاستثمار', 'sector': 'البنوك', 'opinion': 'مختلطة'},
    '1060': {'name': 'البنك السعودي الفرنسي', 'sector': 'البنوك', 'opinion': 'مختلطة'},
    '1080': {'name': 'البنك العربي الوطني', 'sector': 'البنوك', 'opinion': 'مختلطة'},
    '1140': {'name': 'بنك البلاد', 'sector': 'البنوك', 'opinion': 'مختلطة'},
    '1220': {'name': 'بنك الإنماء', 'sector': 'البنوك', 'opinion': 'مختلطة'},
    '1300': {'name': 'المصرف السعودي للتجارة', 'sector': 'البنوك', 'opinion': 'مختلطة'},
    '7010': {'name': 'الاتصالات السعودية', 'sector': 'الاتصالات', 'opinion': 'مختلطة'},
    '7020': {'name': 'زين السعودية', 'sector': 'الاتصالات', 'opinion': 'مختلطة'},
    '7030': {'name': 'موبايلي', 'sector': 'الاتصالات', 'opinion': 'مختلطة'},
    '5110': {'name': 'كهرباء السعودية', 'sector': 'المرافق العامة', 'opinion': 'مختلطة'},
    '4300': {'name': 'دار الأركان', 'sector': 'العقارات', 'opinion': 'مختلطة'},
    '4320': {'name': 'طيبة', 'sector': 'العقارات', 'opinion': 'مختلطة'},
    '4330': {'name': 'مكة', 'sector': 'العقارات', 'opinion': 'مختلطة'},
    '4001': {'name': 'عبدالله العثيم', 'sector': 'التجزئة', 'opinion': 'مختلطة'},
    '8010': {'name': 'التعاونية', 'sector': 'التأمين', 'opinion': 'مختلطة'},
    '8012': {'name': 'بوبا العربية', 'sector': 'التأمين', 'opinion': 'مختلطة'},
    '3001': {'name': 'أسمنت الجنوبية', 'sector': 'المواد الأساسية', 'opinion': 'مختلطة'},
}
