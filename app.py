...
def load_stocks_data():
    ...
    default_stocks = {
        '2222': {'name': 'أرامكو السعودية', 'sector': 'الطاقة', 'opinion': 'نقبة'},
        '1120': {'name': 'البنك الأهلي السعودي', 'sector': 'البنوك', 'opinion': 'نقبة'},
        '2010': {'name': 'سابك', 'sector': 'البتروكيماويات', 'opinion': 'مختلطة'},
        '1090': {'name': 'مصرف الراجحي', 'sector': 'البنوك', 'opinion': 'نقبة'},
        '1210': {'name': 'بنك الرياض', 'sector': 'البنوك', 'opinion': 'نقبة'},
        '1180': {'name': 'بنك الجزيرة', 'sector': 'البنوك', 'opinion': 'نقبة'},
        '7010': {'name': 'الاتصالات السعودية', 'sector': 'الاتصالات', 'opinion': 'نقبة'},
        '2380': {'name': 'الطاقة', 'sector': 'الطاقة', 'opinion': 'مختلطة'},
        '5110': {'name': 'كهرباء السعودية', 'sector': 'المرافق', 'opinion': 'نقبة'},
        '4300': {'name': 'دار الأركان', 'sector': 'العقار', 'opinion': 'نقبة'},
        '4001': {'name': 'عبدالله العثيم', 'sector': 'التجزئة', 'opinion': 'نقبة'},
        '8010': {'name': 'التعاونية', 'sector': 'التأمين', 'opinion': 'نقبة'},
    }
